      ...
      <div className="max-w-[1440px] mx-auto px-5 lg:px-[60px]">
        ...
        >
          <div className="flex items-center gap-2 text-sm font-bold text-gray-400 uppercase tracking-widest mb-4">
            ...
            <span className="hover:text-[#B8860B] cursor-pointer" onClick={() => navigate('/program')}>Program</span>
            <ChevronRight size={14} />
            <span className="text-[#B8860B]">Komunitas Program</span>
          </div>
          <h1 className="text-[40px] lg:text-[56px] font-[900] text-black leading-none tracking-tight">
            Komunitas <span className="text-[#B8860B]">Program</span>
          </h1>
          <div className="w-20 h-1.5 bg-[#B8860B] mt-6 rounded-full"></div>
          <p className="mt-8 text-gray-500 max-w-2xl font-medium text-lg">
            Komunitas-komunitas program Mata Garuda Sulawesi Utara yang aktif dalam berbagai kegiatan pengabdian dan pengembangan diri.
          </p>
        </motion.div>
              ...
              >
                ...
                <div className="relative w-full aspect-video overflow-hidden bg-gray-200">
                  <img 
                    ...
                    onError={(e) => e.target.src = 'https://via.placeholder.com/600x400?text=Komunitas+MG+Sulut'}
                  />
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <h3 className="text-xl font-[900] uppercase tracking-tight mb-3 text-gray-900 group-hover:text-[#B8860B] transition-colors">
                    {item.nama}
                  </h3>
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-50 flex gap-6">
                    <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-tighter text-gray-400">
                      <Users size={14} className="text-[#B8860B]" /> 40+ Anggota
                    </div>
                    <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-tighter text-gray-400">
                      <Trophy size={14} className="text-[#B8860B]" /> 5 Prestasi
                    </div>
                  </div>
                </div>
              </motion.div>
...
export default KomunitasProgram;