...
const Berita3 = () => {
  ...
  const [relatedNews] = useState(() => {
    const sameKategori = beritaData.filter(n => n._id !== '3' && n.kategori === 'Prestasi');
    const other = beritaData.filter(n => n._id !== '3' && n.kategori !== 'Prestasi');
    ...
    <div className="pt-32 lg:pt-44 pb-24 font-urbanist bg-white min-h-screen">
      <div className="max-w-[1440px] mx-auto px-5 lg:px-[60px]">
        <div className="flex items-center gap-2 text-sm font-bold text-gray-400 uppercase tracking-widest mb-8">
          ...
          <ChevronRight size={14} />
          <span className="text-[#587F93]">Prestasi Anggota MG Sulut Kompetisi Nasional</span>
        </div>
        ...
        <div className="lg:grid lg:grid-cols-3 lg:gap-12">
          <motion.article initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="lg:col-span-2 mb-16 lg:mb-0">
            ...
            <h1 className="text-4xl lg:text-5xl font-black text-gray-900 leading-tight mb-8">
              Prestasi Anggota MG Sulut di Kompetisi Nasional
            </h1>
            ...
            <div className="flex flex-wrap gap-6 py-6 border-y border-gray-100 mb-12 text-sm font-bold text-gray-500 uppercase tracking-wide">
              ...
              <div className="flex items-center gap-2">
                <Calendar size={16} />
                <span>5 Okt 2024</span>
              </div>
            </div>

            <div className="mb-12 rounded-3xl overflow-hidden shadow-2xl">
              <img src="/tas1.jpeg" alt="Prestasi Kompetisi" className="w-full h-[400px] lg:h-[500px] object-cover" />
            </div>

            <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed mb-12">
              <p className="mb-8 text-lg font-medium">Tiga anggota MG Sulut meraih podium pertama di Kompetisi Riset Kebijakan Nasional 2024 yang diselenggarakan Kementerian Pemuda dan Olahraga.</p>
              <p className="mb-8 text-lg font-medium"><strong>Juara 1:</strong> Riset "Pemberdayaan Pemuda Sulawesi Utara Era Digital" oleh tim Bintang et al. dengan skor 95.7/100.</p>
              <p className="mb-8 text-lg font-medium"><strong>Juara 2:</strong> "Model Ekonomi Berbasis Potensi Lokal Minahasa Utara" oleh tim Rizal et al.</p>
              <p className="mb-8 text-lg font-medium"><strong>Juara 3:</strong> "Strategi Mitigasi Bencana Alam Sulawesi Utara" oleh tim Sarah et al.</p>
              <p className="mb-8 text-lg font-medium">Prestasi ini menjadi bukti komitmen MG Sulut dalam mencetak generasi muda riset yang berdaya saing tingkat nasional.</p>
            </div>

            <div className="py-8 border-t border-gray-100 mb-12">
              <div className="flex flex-wrap gap-2">
                <span className="px-4 py-2 bg-[#587F93]/10 text-[#587F93] rounded-full text-sm font-bold">#Prestasi</span>
