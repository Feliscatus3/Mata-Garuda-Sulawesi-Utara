...
const Berita1 = () => {
  ...
  const [relatedNews] = useState(() => {
    const sameKategori = beritaData.filter(n => n._id !== '1' && n.kategori === 'Kegiatan');
    const other = beritaData.filter(n => n._id !== '1' && n.kategori !== 'Kegiatan');
    ...
    <div className="pt-32 lg:pt-44 pb-24 font-urbanist bg-white min-h-screen">
      <div className="max-w-[1440px] mx-auto px-5 lg:px-[60px]">
        <div className="flex items-center gap-2 text-sm font-bold text-gray-400 uppercase tracking-widest mb-8">
          ...
          <ChevronRight size={14} />
          <span className="text-[#587F93]">MG Sulut Gelar Pengabdian Desa Bantik</span>
        </div>
        ...
        <div className="lg:grid lg:grid-cols-3 lg:gap-12">
          <motion.article initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="lg:col-span-2 mb-16 lg:mb-0">
            ...
            <h1 className="text-4xl lg:text-5xl font-black text-gray-900 leading-tight mb-8">
              MG Sulut Gelar Pengabdian Desa Bantik
            </h1>
            ...
            <div className="mb-12 rounded-3xl overflow-hidden shadow-2xl">
              <img src="/program-1.webp" alt="Pengabdian Desa Bantik" className="w-full h-[400px] lg:h-[500px] object-cover" />
            </div>

            <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed mb-12">
              <p className="mb-8 text-lg font-medium">Tim Mata Garuda Sulawesi Utara dengan penuh semangat menggelar program pengabdian masyarakat di Desa Bantik, Kabupaten Minahasa Utara.</p>
              <p className="mb-8 text-lg font-medium">Kegiatan ini melibatkan 30+ anggota MG Sulut yang fokus pada bidang pendidikan karakter, pemberdayaan ekonomi masyarakat, dan pelestarian lingkungan.</p>
              <p className="mb-8 text-lg font-medium">Hari pertama diisi dengan workshop kepemimpinan untuk pemuda desa, diikuti praktik langsung pembuatan pupuk organik dan penanaman pohon mangrove.</p>
              <p className="mb-8 text-lg font-medium">Kepala Desa Bantik mengapresiasi tinggi kontribusi MG Sulut dan berharap program serupa dapat dilanjutkan secara berkala.</p>
              <p className="mb-8 text-lg font-medium">Program ini merupakan bagian dari komitmen MG Sulut untuk memberikan dampak nyata bagi masyarakat Sulawesi Utara.</p>
            </div>
            ...
            <div className="py-8 border-t border-gray-100 mb-12">
              <div className="flex flex-wrap gap-2">
                ...
                <span className="px-4 py-2 bg-[#587F93]/10 text-[#587F93] rounded-full text-sm font-bold">#Pengabdian</span>
                <span className="px-4 py-2 bg-[#587F93]/10 text-[#587F93] rounded-full text-sm font-bold">#DesaBantik</span>
              </div>
            </div>
