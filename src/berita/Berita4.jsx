    ...
    <div className="pt-32 lg:pt-44 pb-24 font-urbanist bg-white min-h-screen">
      <div className="max-w-[1440px] mx-auto px-5 lg:px-[60px]">
        <div className="flex items-center gap-2 text-sm font-bold text-gray-400 uppercase tracking-widest mb-8">
          ...
          <ChevronRight size={14} />
          <span className="text-[#587F93]">Riset Kebijakan Sulawesi Utara Dirilis</span>
        </div>
        ...
        <div className="lg:grid lg:grid-cols-3 lg:gap-12">
          <motion.article initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="lg:col-span-2 mb-16 lg:mb-0">
            ...
            <h1 className="text-4xl lg:text-5xl font-black text-gray-900 leading-tight mb-8">
              Riset Kebijakan Sulawesi Utara Dirilis
            </h1>
            ...
            <div className="mb-12 rounded-3xl overflow-hidden shadow-2xl">
              <img src="/greenhouse.webp" alt="Riset Kebijakan" className="w-full h-[400px] lg:h-[500px] object-cover" />
            </div>

            <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed mb-12">
              <p className="mb-8 text-lg font-medium">Laporan riset kebijakan monumental 'Pembangunan Sulawesi Utara 2025-2030' resmi dirilis oleh Mata Garuda Sulawesi Utara.</p>
              <p className="mb-8 text-lg font-medium">Dokumen setebal 200+ halaman ini menganalisis mendalam 5 sektor prioritas: ekonomi kreatif, pendidikan karakter, kesehatan masyarakat, pelestarian lingkungan, dan infrastruktur berkelanjutan.</p>
              <p className="mb-8 text-lg font-medium">Riset dilakukan selama 6 bulan melibatkan 50 akademisi terkemuka, praktisi industri, dan pemangku kepentingan pemerintahan provinsi.</p>
              <p className="mb-8 text-lg font-medium">Rekomendasi kebijakan diserahkan langsung kepada Gubernur Sulawesi Utara dan seluruh anggota DPRD Provinsi Sulawesi Utara.</p>
              <p className="mb-8 text-lg font-medium">Laporan lengkap tersedia untuk download gratis di website resmi MG Sulut dan dapat diakses oleh seluruh masyarakat Sulawesi Utara.</p>
            </div>

            <div className="py-8 border-t border-gray-100 mb-12">
              <div className="flex flex-wrap gap-2">
                <span className="px-4 py-2 bg-[#587F93]/10 text-[#587F93] rounded-full text-sm font-bold">#Riset</span>
                <span className="px-4 py-2 bg-[#587F93]/10 text-[#587F93] rounded-full text-sm font-bold">#Kebijakan</span>
              </div>
            </div>
